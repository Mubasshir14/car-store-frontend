  ...
  useEffect(() => {
    if (carData?.data) {
      reset({
        ...
        image: carData.data.image,
        year: carData.data.year,
        price: carData.data.price,
        milage: carData.data.milage,
        quantity: carData.data.quantity,
        ...
        <CardContent className="p-8 bg-white">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={name} className="relative group">
                  <Label
                    htmlFor={name}
                    className="text-lg font-semibold text-gray-700 group-hover:text-red-600 transition-colors"
                  >
                    {label}
                  </Label>
                  <Input
                    ...
                    className="border-2 border-gray-300 focus:border-red-500 transition-colors 
              ...
              <div className="relative group">
                <Label className="text-lg font-semibold text-gray-700 group-hover:text-blue-600 transition-colors">
                  Category
                </Label>
                <Controller
                  control={control}
              ...
              {/* Fuel Type Dropdown */}
              <div className="relative group">
                <Label className="text-lg font-semibold text-gray-700 group-hover:text-red-600 transition-colors">
                  Fuel Type
                </Label>
                <Controller
                  control={control}
            ...
            <Button
              ...
              disabled={isUpdating}
            >
              {isUpdating ? "Updating Car..." : "Update Car"}
            </Button>
          </form>
        </CardContent>
      </Card>
